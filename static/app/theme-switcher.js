...
// 主题常量
const THEME_KEY = 'gemini2api_theme';
...
function updateMetaThemeColor(theme) {
    ...
    if (metaThemeColor) {
        // 暗黑主题使用深色，亮色主题使用主色调
        metaThemeColor.setAttribute('content', theme === THEME_DARK ? '#1f2937' : '#4285f4');
    }
}
 ...
 */
function initThemeSwitcher(toggleButtonId = 'themeToggleBtn') {
    // 应用保存的主题或系统偏好
